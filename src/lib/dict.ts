  ...
  en: {
    ...
    casePage: {
      ...
      guide: {
        ...
        shots: "these are live captures from the game, not mockups",
        task: "the client brought an idea \u2014 we brought physics and balance",
        built: "and all of it lives inside Telegram, no app stores",
        flow: "four sprints from idea to release",
        eras: "watch my antenna \u2014 networks upgrade as you scroll",
  ...
  ru: {
    ...
    casePage: {
      ...
      guide: {
        ...
        shots: "это живые кадры из игры, не мокапы",
        task: "клиент пришёл с идеей — мы принесли физику и баланс",
        built: "и всё это внутри telegram, без сторов",
        flow: "четыре спринта от идеи до релиза",
        eras: "следи за антенной: сети качаются вместе со скроллом",
