...
export const dict = {
  en: {
      ...
      items: [
        ...
        },
        {
          ...
          strip: [
            ...
            {
              img: "/cases/novy-kovcheg-hall.webp",
              cap: "the Grand hall",
              alt: "Grand hall page with a live banquet photo",
            },
            {
              img: "/cases/novy-kovcheg-menu.webp",
              cap: "three menus",
    ...
    casePage: {
      ...
      link: "https://novi-uroven.vercel.app",
      shots: [
        { img: "/cases/novy-uroven-menu.webp", cap: "menu \u2014 any frame reads as T2" },
        { img: "/cases/novy-uroven.webp", cap: "gameplay: towers, wires, a new record" },
        { img: "/cases/novy-uroven-over.webp", cap: "game over \u2014 \u201cStuck on 2G. That hurts\u201d" },
      ],
      taskH: "The task",
      ...
      eras: [
        { img: "/cases/novy-uroven-3g.webp", cap: "3G \u00b7 \u201cUzhe chto-to\u201d \u2014 getting somewhere" },
        { img: "/cases/novy-uroven-lte.webp", cap: "LTE \u00b7 time to speed up" },
        { img: "/cases/novy-uroven-5g.webp", cap: "5G \u00b7 almost space" },
        { img: "/cases/novy-uroven-6g.webp", cap: "6G \u00b7 \u201cThe future. You\u2019re first here\u201d" },
      ],
      stackH: "Stack",
    ...
    casePageNk: {
      ...
      link: "https://noviykovcheg.ru",
      shots: [
        { img: "/cases/novy-kovcheg.webp", cap: "entrance \u2014 dark velvet and a chandelier" },
        { img: "/cases/novy-kovcheg-hall.webp", cap: "the Grand hall with live banquet photos" },
        { img: "/cases/novy-kovcheg-menu.webp", cap: "three menus \u2014 honest price per guest" },
      ],
      taskH: "The task",
      ...
      more: [
        { img: "/cases/novy-kovcheg-halls.webp", cap: "four halls for any scale" },
        { img: "/cases/novy-kovcheg-demo.webp", cap: "the owner shows all four halls in person" },
        { img: "/cases/novy-kovcheg-form.webp", cap: "contacts \u2014 phones, Telegram, VK" },
      ],
      stackH: "Stack",
  ...
  ru: {
    ...
    casePage: {
      ...
      link: "https://novi-uroven.vercel.app",
      shots: [
        { img: "/cases/novy-uroven-menu.webp", cap: "меню — любой кадр узнаваем как T2" },
        { img: "/cases/novy-uroven.webp", cap: "геймплей: вышки, провода, новый рекорд" },
        { img: "/cases/novy-uroven-over.webp", cap: "проигрыш — «Застряли на 2G. Даже обидно»" },
      ],
      taskH: "Задача",
      ...
      eras: [
        { img: "/cases/novy-uroven-3g.webp", cap: "3G · «Уже что-то»" },
        { img: "/cases/novy-uroven-lte.webp", cap: "LTE · «Можно ускоряться»" },
        { img: "/cases/novy-uroven-5g.webp", cap: "5G · «Почти космос»" },
        { img: "/cases/novy-uroven-6g.webp", cap: "6G · «Будущее. Вы в нём первый»" },
      ],
      stackH: "Стек",
      stack: ["React 18", "TypeScript strict", "Vite", "PixiJS 8 \u00b7 WebGL", "Zustand", "PWA \u00b7 Workbox", "IndexedDB", "Neon"],
    ...
    casePageNk: {
      ...
      link: "https://noviykovcheg.ru",
      shots: [
        { img: "/cases/novy-kovcheg.webp", cap: "вход \u2014 тёмный бархат и люстра" },
        { img: "/cases/novy-kovcheg-hall.webp", cap: "Большой зал с живыми фото банкета" },
        { img: "/cases/novy-kovcheg-menu.webp", cap: "три меню \u2014 честная цена за гостя" },
      ],
      taskH: "Задача",
      ...
      more: [
        { img: "/cases/novy-kovcheg-halls.webp", cap: "четыре зала на любой масштаб" },
        { img: "/cases/novy-kovcheg-demo.webp", cap: "владелец сам показывает все четыре зала" },
        { img: "/cases/novy-kovcheg-form.webp", cap: "контакты \u2014 телефоны, Telegram, ВК" },
      ],
      stackH: "Стек",
      stack: ["Astro 5", "TypeScript", "GSAP", "Lenis", "Sharp", "PHP \u2192 Telegram"],
